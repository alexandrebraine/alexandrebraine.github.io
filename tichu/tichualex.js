...
layoutrow.addEventListener('click', () => {
    tableplayers.style.gridTemplateAreas = '"top" "right" "bottom" "left"'
})

layoutclock.addEventListener('click', () => {
    tableplayers.style.gridTemplateAreas = '". top top top ." "left left . right right" ".  bottom bottom bottom ."'
})

layoutanticlock.addEventListener('click', () => {
    tableplayers.style.gridTemplateAreas = '". top top top ." "right right . left left" ".  bottom bottom bottom ."'
})